...
export function ProductionTabBar({ state, descriptors, navigation }: BottomTabBarProps) {
  const insets = useSafeAreaInsets();

  const tabs = {
    index: { label: "Queue", compactLabel: "QUEUE", icon: "list" },
    shift: { label: "Shift", compactLabel: "SHIFT", icon: "clock" }
  } as const;
